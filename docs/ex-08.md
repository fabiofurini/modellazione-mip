...
| $LB$ (euristica costruttiva) | $z(\mathrm{MILP})$ | $z(\mathrm{LP})$ | $UB$ (duale a mano) | gap euristica |
|---:|---:|---:|---:|---:|
| 18 | 18 | 18 | 18 | $0{,}0\%$ |

Qui i due bound costruiti a mano **chiudono** il problema: $z(\mathrm{MILP}) = 18$
